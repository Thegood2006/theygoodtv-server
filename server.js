/**
 * THEY GOOD TV ÃÂ¢ÃÂÃÂ Servidor v6.0
 * Streams reales verificados ÃÂ¢ÃÂÃÂ Sin Puppeteer
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ CACHÃÂÃÂ 50 minutos ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
const cache = {};
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
   ...
   url       = pÃÂÃÂ¡gina oficial (fallback / info)
   ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
let CANALES = {

  /* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ ECUADOR ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
  "tc": {
    nombre: "TC TelevisiÃÂÃÂ³n",
    url: "https://tctelevision.com/envivo/",
    // TC usa Dailymotion ÃÂ¢ÃÂÃÂ el extractor lo captura solo
  },
  "ecuavisa": {
    nombre: "Ecuavisa",
  ...
  "ecdf": {
    nombre: "El Canal del FÃÂÃÂºtbol",
    url: "https://ecdf.ec",
    embedFijo: {
      tipo: "iframe",
  ...
  /* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ COLOMBIA ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
  "caracol": {
  ...
  /* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ INTERNACIONALES ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
  "cnn-espanol": {
    nombre: "CNN en EspaÃÂÃÂ±ol",
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ EXTRACTOR DE EMERGENCIA (para canales sin embedFijo) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
async function extraerStream(url) {
  try {
    ...
    // 2. Dailymotion video ID genÃÂÃÂ©rico
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ TEMPLATES HTML ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
...
<div style="font-size:3rem">ÃÂ°ÃÂÃÂÃÂ¡</div>
<h2>Stream no disponible</h2>
<p>${nombre} no pudo ser extraÃÂÃÂ­do en este momento. El canal puede estar offline o cambiÃÂÃÂ³ su reproductor.</p>
<a href="${urlOriginal}" target="_blank">Ver en sitio oficial ÃÂ¢ÃÂÃÂ</a>
</body></html>`;
}
...
app.get("/live/:canal/player", async (req, res) => {
  ...
  // Si tiene embed fijo, ÃÂÃÂºsalo directo sin fetch
  if (info.embedFijo) {
    const data = { nombre: info.nombre, ...info.embedFijo };
    console.log(`[player] ${info.nombre} ÃÂ¢ÃÂÃÂ ${data.tipo} (${data.fuente}) [FIJO]`);
    if (data.tipo === "m3u8")   return res.send(htmlM3U8(data));
    if (data.tipo === "iframe") return res.send(htmlIframe(data));
  }

  // Si no tiene embedFijo, intentar extracciÃÂÃÂ³n dinÃÂÃÂ¡mica con cachÃÂÃÂ©
  let data = getCached("live_" + key);
  if (!data) {
    console.log(`[player] Extrayendo dinÃÂÃÂ¡micamente: ${info.nombre}`);
  ...
  console.log(`[player] ${info.nombre} ÃÂ¢ÃÂÃÂ ${data.tipo} (${data.fuente})`);
  if (data.tipo === "m3u8")   return res.send(htmlM3U8(data));
  if (data.tipo === "iframe") return res.send(htmlIframe(data));
});
...
app.post("/live-add", (req, res) => {
  ...
  if (embed) {
    // Si mandan embed directo, ÃÂÃÂºsalo como embedFijo
    CANALES[canalId] = {
      nombre,
      url: url || embed,
    ...
    // Si solo mandan URL, intentar extracciÃÂÃÂ³n dinÃÂÃÂ¡mica
  ...
  res.json({
    ...
    consejo: embed ? "Stream fijo guardado ÃÂ¢ÃÂÃÂ" : "Se extraerÃÂÃÂ¡ dinÃÂÃÂ¡micamente al primer acceso"
  });
});
...
/* PÃÂÃÂ¡gina principal (index visual) */
app.get("/", (req, res) => {
  const grupos = {
    "ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂ¨ Ecuador": ["tc","ecuavisa","teleamazonas","rts","canal-uno","gama-tv","ecdf","ecuador-tv"],
    "ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ´ Colombia": ["caracol","rcn"],
    "ÃÂ°ÃÂÃÂÃÂ Internacional": ["cnn-espanol","record","antena3"]
  };
  ...
  for (const [grupo, ids] of Object.entries(grupos)) {
    const items = ids.map(k => {
      const v = CANALES[k];
      if (!v) return "";
      const badge = v.embedFijo ? `<span style="color:#00ff99;font-size:.6rem">ÃÂ¢ÃÂÃÂ FIJO</span>` : `<span style="color:#ffc800;font-size:.6rem">ÃÂ¢ÃÂÃÂ DIN</span>`;
...
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>THEY GOOD TV ÃÂ¢ÃÂÃÂ API v6</title>
...
<h1>THEY GOOD TV</h1>
<p class="sub">Stream API ÃÂÃÂ· v6.0 ÃÂÃÂ· ${Object.keys(CANALES).length} canales</p>
<div class="info">
  ...
  <span style="color:#00ff99">ÃÂ¢ÃÂÃÂ FIJO</span> = stream hardcodeado (siempre disponible) &nbsp;|&nbsp; 
  <span style="color:#ffc800">ÃÂ¢ÃÂÃÂ DIN</span> = extraÃÂÃÂ­do dinÃÂÃÂ¡micamente
</div>
${secciones}
...
app.listen(PORT, () => {
  ...
  console.log(`\nÃÂ¢ÃÂÃÂ THEY GOOD TV Server v6.0 ÃÂ¢ÃÂÃÂ Puerto ${PORT}`);
  console.log(`ÃÂ°ÃÂÃÂÃÂ¡ ${Object.keys(CANALES).length} canales (${fijos} con stream fijo, ${Object.keys(CANALES).length - fijos} dinÃÂÃÂ¡micos)`);
  console.log(`ÃÂ°ÃÂÃÂÃÂ Canales: ${Object.keys(CANALES).join(", ")}\n`);
});
